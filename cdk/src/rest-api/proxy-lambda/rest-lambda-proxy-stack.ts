...
export class ProxyLambda extends Stack {
  constructor(app: App, id: string, props: StackProps) {
    ...
    // Rest Proxy Function
    const restProxyFnPath = `${__dirname}/../../../../deploy/rest-api/project-template.zip`;
    const restProxyLambda: Function = new Function(
      this,
      'RestAPI_ProxyLambda',
      {
    ...
    new StringParameter(this, 'RestApiProxyLambdaArnParameter', {
      parameterName: '/ProjectTemplate/RestApi/ProxyLambda/Arn',
